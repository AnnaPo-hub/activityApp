...
**startDate** | [**LocalDate**](LocalDate.md) | The time at which the effort was started. |  [optional]
**startDateLocal** | [**LocalDate**](LocalDate.md) | The time at which the effort was started in the local timezone. |  [optional]
