...
import ru.otus.activity.client.model.DetailedSegmentEffort;
import ru.otus.activity.client.model.Fault;
...
@Component("ru.otus.activity.client.api.SegmentEffortsApi")
public class SegmentEffortsApi {
     ...
     */
    public List<DetailedSegmentEffort> getEffortsBySegmentId(Integer segmentId, DateTime startDateLocal, DateTime endDateLocal, Integer perPage) throws RestClientException {
