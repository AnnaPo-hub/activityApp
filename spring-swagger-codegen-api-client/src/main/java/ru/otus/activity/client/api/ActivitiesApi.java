...
@Component("ru.otus.activity.client.api.ActivitiesApi")
public class ActivitiesApi {
     ...
     * @param hideFromHome   Set to true to mute activity.
     * @return DetailedActivity
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public DetailedActivity createActivity(String name, String type, LocalDate startDateLocal, Integer elapsedTime, String description, Float distance, Integer trainer, Integer commute, Boolean hideFromHome) throws RestClientException {
